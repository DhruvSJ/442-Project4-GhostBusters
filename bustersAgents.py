...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for belief in livingGhostPositionDistributions:
            maxPosition = belief.argMax()
            dist = self.distancer.getDistance(maxPosition ,pacmanPosition)
            if not minPos:
                minPos = dist
                closePos = maxPosition
            elif dist < minPos:
                minPost = dist
                closePos = maxPosition
        ...
        for action in legal:
            ...
            newDis = self.distancer.getDistance(newPos,closePos)
            if not minPos:
                minPos = newDis
                bestAction = action
            elif newDis < minPos:
